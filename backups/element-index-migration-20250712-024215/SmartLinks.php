...
class SmartLinks extends Plugin
{
    ...
    public function getCpNavItem(): ?array
    {
        ...
        if ($item) {
            $item['label'] = Craft::t('smart-links', 'Smart Links');
    ...
    {
        // Load settings from database instead of creating new
    ...
    {
        return [
            'smart-links' => 'smart-links/smart-links/index',
            'smart-links/smartlinks' => 'smart-links/smart-links/index',
